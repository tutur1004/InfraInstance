...
public class Storage {
    ...
    public static final long INSTANCES_DELAY = TimeUnit.MILLISECONDS.convert(5L, TimeUnit.SECONDS);
    public static Map<Instance, Date> INSTANCES_CACHE = new HashMap<>();
    public static final long USERS_DELAY = TimeUnit.MILLISECONDS.convert(5L, TimeUnit.SECONDS);
